...
class ShipmentAPITests(APITestCase):
    ...
    def test_create_with_location(self):
        ...
        self.assertEqual(response_included[1]['attributes']['city'], parameters['_ship_from_location_city'])
        self.assertEqual(response_included[1]['attributes']['state'], parameters['_ship_from_location_state'])
        self.assertEqual(response_included[1]['attributes']['geometry']['coordinates'], [12.0, 23.0])
        ...
        self.assertEqual(response_included[1]['attributes']['city'], parameters['_ship_from_location_city'])
        self.assertEqual(response_included[1]['attributes']['state'], parameters['_ship_from_location_state'])
        self.assertEqual(response_included[1]['attributes']['name'], parameters['_ship_from_location_name'])
        self.assertEqual(response_included[1]['attributes']['geometry']['coordinates'], [12.0, 23.0])

        self.assertIsNotNone(response_data['relationships']['ship_to_location']['data'])
        self.assertEqual(len(response_included), 3)
        self.assertEqual(response_included[2]['attributes']['city'], parameters['_ship_from_location_city'])
        self.assertEqual(response_included[2]['attributes']['state'], parameters['_ship_from_location_state'])
        self.assertEqual(response_included[2]['attributes']['name'], parameters['_ship_to_location_name'])
        self.assertEqual(response_included[2]['attributes']['geometry']['coordinates'], [12.0, 23.0])
